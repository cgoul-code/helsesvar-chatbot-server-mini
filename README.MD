...
To access logging:
az webapp log config -g rg-webappaichatbot -n chatbot3-llama-server --application-logging true --web-server-logging filesystem
az webapp log tail  -g rg-webappaichatbot -n chatbot3-llama-server
